...
import { Check, Scissors, Calendar, BarChart3, Globe, Star, PieChart } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <nav className="border-b border-gray-100 bg-white/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 h-16 flex justify-between items-center">
          ...
          <div className="flex gap-3">
             <Button variant="outline" className="text-sm px-4 py-1.5" onClick={onEnterSystem}>
               Área do Cliente
             </Button>
          </div>
        </div>
      ...
      <header className="relative overflow-hidden pt-12 pb-20 lg:pt-24 lg:pb-32">
        <div className="max-w-6xl mx-auto px-4 relative z-10 text-center flex flex-col items-center">
            ...
            {/* Social Proof (Já aderiram) - Now Clickable */}
            <div 
              onClick={onViewDirectory}
              className="group cursor-pointer flex items-center gap-4 mb-8 bg-white/50 border border-gray-200 p-2 pr-6 rounded-full shadow-sm backdrop-blur-sm animate-in fade-in slide-in-from-bottom-4 hover:border-brand-200 hover:shadow-md transition-all"
            >
            ...
            <div className="flex flex-col items-center gap-6 w-full">
              <Button 
                className="h-14 px-12 text-lg font-bold rounded-full shadow-xl shadow-brand-500/30 hover:shadow-brand-500/50 transition-all transform hover:-translate-y-1 w-full sm:w-auto uppercase tracking-wide bg-brand-600 hover:bg-brand-700 text-white" 
              ...
              {/* App Store Badges */}
              <div className="flex gap-4 items-center justify-center opacity-80 hover:opacity-100 transition-opacity">
      ...
      <section id="planos" className="py-20">
         <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 items-center">
               ...
               {/* Start Plan */}
               <div className="bg-white border border-gray-100 rounded-[2rem] p-8 shadow-sm hover:shadow-lg transition-all h-fit">
                  <div className="text-center mb-6">
                      <h3 className="text-sm font-bold text-gray-900 mb-2">Start</h3>
                      <div className="flex justify-center items-baseline gap-1">
                        <span className="text-4xl font-extrabold text-gray-900">R$ 0</span>
                        <span className="text-gray-400 text-sm">/mês</span>
                      </div>
                      <p className="text-gray-400 text-sm mt-1">0</p>
                  </div>
                  
                  <ul className="space-y-4 mb-8 text-sm">
                     <li className="flex items-center gap-3 text-gray-600">
                        <div className="rounded-full bg-green-100 p-1"><Check className="w-3 h-3 text-green-600" /></div> Agenda Simples
                     </li>
                     <li className="flex items-center gap-3 text-gray-600">
                        <div className="rounded-full bg-green-100 p-1"><Check className="w-3 h-3 text-green-600" /></div> Link Personalizado
                     </li>
                     <li className="flex items-center gap-3 text-gray-600">
                        <div className="rounded-full bg-green-100 p-1"><Check className="w-3 h-3 text-green-600" /></div> Até 50 agendamentos/mês
                     </li>
                  </ul>
                  <Button variant="secondary" className="w-full rounded-xl py-3 font-semibold bg-gray-100 text-gray-600 hover:bg-gray-200 border-0" onClick={onEnterSystem}>
                    Começar Agora
                  </Button>
               </div>

               {/* Professional Plan (Highlighted) */}
               <div className="bg-white border-2 border-brand-100 rounded-[2rem] p-8 shadow-2xl relative transform scale-105 z-10">
                  ...
                  <div className="text-center mb-6">
                      <h3 className="text-sm font-bold text-gray-900 mb-2">Profissional</h3>
                      <div className="flex justify-center items-baseline gap-1">
                        <span className="text-5xl font-extrabold text-gray-900">R$ 29.9</span>
                        <span className="text-gray-400 text-sm">/mês</span>
                      </div>
                      <p className="text-brand-500 font-semibold text-xs mt-2">+ R$ 10 por profissional</p>
                      <Badge color="gray" className="mt-2 bg-gray-100 text-gray-600 border border-gray-200">INCLUI 1 PROFISSIONAL(IS)</Badge>
                  </div>
                  
                  <ul className="space-y-4 mb-8 text-sm">
                     <li className="flex items-center gap-3 text-gray-600">
                        <div className="rounded-full bg-green-100 p-1"><Check className="w-3 h-3 text-green-600" /></div> Agenda Ilimitada
                     </li>
                     <li className="flex items-center gap-3 text-gray-600">
                        <div className="rounded-full bg-green-100 p-1"><Check className="w-3 h-3 text-green-600" /></div> Controle Financeiro
                     </li>
                     <li className="flex items-center gap-3 text-gray-600">
                        <div className="rounded-full bg-green-100 p-1"><Check className="w-3 h-3 text-green-600" /></div> Gestão de Estoque
                     </li>
                     <li className="flex items-center gap-3 text-gray-600">
                        <div className="rounded-full bg-green-100 p-1"><Check className="w-3 h-3 text-green-600" /></div> Site Próprio
                     </li>
                  </ul>
                  <Button className="w-full rounded-xl py-4 font-bold bg-brand-600 hover:bg-brand-700 text-white shadow-lg shadow-brand-200" onClick={onEnterSystem}>
                    Assinar Agora
                  </Button>
               </div>
               ...
               <div className="bg-white border border-gray-100 rounded-[2rem] p-8 shadow-sm hover:shadow-lg transition-all h-fit">
                  <div className="text-center mb-6">
                      <h3 className="text-sm font-bold text-gray-900 mb-2">Redes</h3>
                      <div className="flex justify-center items-baseline gap-1">
                        <span className="text-4xl font-extrabold text-gray-900">R$ 19.9</span>
                        <span className="text-gray-400 text-sm">/mês</span>
                      </div>
                      <p className="text-brand-500 font-semibold text-xs mt-2">+ R$ 10 por profissional</p>
                      <Badge color="gray" className="mt-2 bg-gray-100 text-gray-600 border border-gray-200">INCLUI 11 PROFISSIONAL(IS)</Badge>
                  </div>
                  
                  <ul className="space-y-4 mb-8 text-sm">
                     <li className="flex items-center gap-3 text-gray-600">
                        <div className="rounded-full bg-green-100 p-1"><Check className="w-3 h-3 text-green-600" /></div> Múltiplos Profissionais (+10)
                     </li>
                     <li className="flex items-center gap-3 text-gray-600">
                        <div className="rounded-full bg-green-100 p-1"><Check className="w-3 h-3 text-green-600" /></div> Dashboard Avançado
                     </li>
                     <li className="flex items-center gap-3 text-gray-600">
                        <div className="rounded-full bg-green-100 p-1"><Check className="w-3 h-3 text-green-600" /></div> Campanhas de Marketing
                     </li>
                     <li className="flex items-center gap-3 text-gray-600">
                        <div className="rounded-full bg-green-100 p-1"><Check className="w-3 h-3 text-green-600" /></div> Suporte Prioritário
                     </li>
                  </ul>
                  <Button variant="secondary" className="w-full rounded-xl py-3 font-semibold bg-gray-100 text-gray-600 hover:bg-gray-200 border-0" onClick={onEnterSystem}>
                    Assinar Agora
      ...
      <footer className="bg-gray-900 text-gray-400 py-12">
        ...
        <div className="max-w-6xl mx-auto px-4 mt-12 pt-8 border-t border-gray-800 text-center text-xs">
            © 2024 Salão Online MVP. Todos os direitos reservados.
        </div>
      </footer>
    </div>
  );
